...
<head>
    ...
    <title>Kalebwangu online Shopping</title>
...
<body class="biolife-body">
    ...
    <header id="header" class="header-area style-01 layout-03">
        ...
        <div class="header-middle biolife-sticky-object ">
                                        ...
                                        <div class="mega-content">
                                            <div
                                                ...
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
            <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Mutinta Shop<span class="caret"></span></a>
            ...
            <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Lubona shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Three Brothers<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
       ...
       <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Golden lay<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">DAP<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
              ...
              ?>
                                                        ...
                                                        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Capital Fisheries<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
              ...
              ?>
                                                        ...
                                                        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Local Market Products<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
                                            ...
                                            <div
                                                ...
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">BBJ clothing shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
              ...
              ?>
                                                        ...
                                                        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Janifer shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
              ...
              ?>
                                                        ...
                                                        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Rose Mary Shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">T-Junction Shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
              ...
              ?>
                                            ...
                                            <div
                                                ...
                                                <div class="wrap-custom-menu vertical-menu ">
                                                    ...
                                                    <ul class="menu">
                                                    <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Chansa shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blueberry Shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">FTJ shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Laski shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
              ...
              ?>
                                            ...
                                            <div
                                                ...
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                    <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Lutanda shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Malati shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">SM shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">BJ shop<span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <?php
                            ...
                            <div class="minicart-block">
                                <div class="minicart-contain">
                                    <a href="javascript:void(0)" class="link-to">
                                        ...
                                        <a href="cart_view.php" class="btn view-cart"><span class="title">My Cart -</span></a>
                                    ...
                                    <div class="cart-content">
                                        <div class="cart-inner">
                                            ...
                                            <p class="btn-control">
                                                <a href="cart_view.php" class="btn view-cart">view cart</a>
                                                <a href="cart_details.php" class="btn">checkout</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-9 col-md-8 padding-top-2px">
                        ...
                        <div class="live-info">
                            <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b
                                    class="phone-number">(+260) 970 202 466/ +260772042339</b></p>
                    ...
                    <li>
                        <div class="slide-contain slider-opt03__layout01">
                            ...
                            <div class="text-content">
                                ...
                                <p class="buttons">
                                    <a href="product.php" class="btn btn-bold">Shop now</a>
                                    <a href="category.php" class="btn btn-thin">View lookbook</a>
                                </p>
                            </div>
                        </div>
                    </li>
                                ...
                                <div class="banner-contain">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <div class="buttons">
                                                <a href="cart_add.php" class="btn add-to-cart-btn">add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="services-list">
                            ...
                            <li>
                                <div class="service-inner">
                                    ...
                                    <a class="srv-name" href="homepay.php">place and delivery on time</a>
                                </div>
                            </li>
                            <li>
                                <div class="service-inner">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="slide-down-box">
                                                    ...
                                                    <div class="buttons">
                                                        ...
                                                        <a href="cart_add.php" class="btn add-to-cart-btn"><i
